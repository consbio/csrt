...
import TraitStep from 'seedsource-ui/src/components/TraitStep'
    ...
    <App navContent={<Menu />}>
      <Sidebar aboutNode={<About />}>
        <RunConfiguration>
          ...
          <RegionStep number={3} />
          <ClimateStep number={4} active siteHelpText="When should plants be best adapted to the planting site?" />
